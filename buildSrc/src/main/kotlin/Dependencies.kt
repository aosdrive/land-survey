object Dependencies {
    ...
    val constraintlayout by lazy { "androidx.constraintlayout:constraintlayout:${Versions.constraitLayout}" }
    ...
    // Navigation
    val lifecycleNavigationFragmentKtx by lazy { "androidx.navigation:navigation-fragment-ktx:${Versions.lifecycleNavigationFragmentKtx}" }
    val lifecycleNavigationUiKtx by lazy { "androidx.navigation:navigation-ui-ktx:${Versions.lifecycleNavigationUiKtx}" }
    ...
    val OkhttpLoggingIntercepter by lazy { "com.squareup.okhttp3:logging-interceptor:${Versions.okhttp}" }
...
//    val roomCoroutines by lazy { "androidx.room:room-coroutines:${Versions.room}" }
    ...
    // External Libraries
    val loadingButton by lazy { "com.github.leandroborgesferreira:loading-button-android:${Versions.loadingButton}" }
    val glide by lazy { "com.github.bumptech.glide:glide:${Versions.glide}" }
    val circleImageview by lazy { "de.hdodenhof:circleimageview:${Versions.circleImageview}" }
    val viewpagerIndicator by lazy { "io.github.vejei.viewpagerindicator:viewpagerindicator:${Versions.viewpagerIndicator}" }
    val stepView by lazy { "com.github.shuhart:stepview:${Versions.stepView}" }
