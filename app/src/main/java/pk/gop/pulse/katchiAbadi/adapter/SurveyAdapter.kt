...
class SurveyAdapter(private val listener: SurveyItemClickListener) :
    ListAdapter<SurveyEntity, SurveyAdapter.SurveyViewHolder>(SurveyDiffCallback()) {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SurveyViewHolder {
        val binding =
            CardviewSurveyListTableBinding.inflate(
    ...
    inner class SurveyViewHolder(private val binding: CardviewSurveyListTableBinding) :
        ...
        fun bind(survey: SurveyEntity) {
            binding.apply {
                ...
                if (survey.isAttached) {
                    tvAttach.visibility = View.INVISIBLE
                } else {
                ...
                tvAttach.setOnClickListener {
                    ...
                    if (position != RecyclerView.NO_POSITION) {
                        ...
                        listener.onSurveyItemClicked(item)
                    }
                }
            }
        }
