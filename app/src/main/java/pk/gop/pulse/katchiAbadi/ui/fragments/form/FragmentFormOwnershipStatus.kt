...
import pk.gop.pulse.katchiAbadi.databinding.FragmentFormOwnershipStatusBinding
...
@AndroidEntryPoint
class FragmentFormOwnershipStatus : Fragment(), RadioGroup.OnCheckedChangeListener {
    private val viewModel: SharedFormViewModel by activityViewModels()

    private var _binding: FragmentFormOwnershipStatusBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentFormOwnershipStatusBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onResume() {
        ...
        binding.apply {
            ...
            rgOwnershipType.setOnCheckedChangeListener(this@FragmentFormOwnershipStatus)
            ...
            btnNext.setOnClickListener {
                ...
                if (isAdded) {
//                    findNavController().navigate(R.id.action_fragmentFormOwnershipStatus_to_fragmentFormOccupancyDetails)
                }
            }
